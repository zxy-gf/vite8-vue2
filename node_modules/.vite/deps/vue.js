// node_modules/.pnpm/vue@2.5.22/node_modules/vue/dist/vue.runtime.esm.js
...
if (true) {
  ...
  warnReservedPrefix = function(target2, key) {
    warn(
      'Property "' + key + '" must be accessed with "$data.' + key + '" because properties starting with "$" or "_" are not proxied in the Vue instance to prevent conflicts with Vue internalsSee: https://vuejs.org/v2/api/#data',
      target2
    );
  };
...
function resolveInject(inject, vm) {
  if (inject) {
    ...
    var keys = hasSymbol ? Reflect.ownKeys(inject).filter(function(key2) {
      return Object.getOwnPropertyDescriptor(inject, key2).enumerable;
    }) : Object.keys(inject);
    for (var i = 0; i < keys.length; i++) {
      var key = keys[i];
  ...
  if (value) {
    if (!isObject(value)) {
      ...
      var loop = function(key2) {
        ...
        if (!(key2 in hash) && !(camelizedKey in hash)) {
...
export {
  vue_runtime_esm_default as default
};
